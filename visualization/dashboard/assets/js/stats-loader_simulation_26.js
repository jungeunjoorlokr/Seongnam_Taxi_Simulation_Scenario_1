// stats-loader.js 수정 버전 - 절대 경로 사용
       async function loadAndApplyStats() {
           ...
           try {
               // 절대 경로로 시도
               const csvUrl = 'file:///Users/jung-eunjoo/Desktop/scenario_seongnam_general_dispatch/visualization/dashboard/assets/data/simulation_26_data/stats.csv';
               ...
               // 실제 CSV 값으로 하드코딩
               document.getElementById('total-calls').textContent = '1575';
               document.getElementById('total-failed-calls').textContent = '0';
               document.getElementById('failure-rate').textContent = '0.0';
               document.getElementById('vehicles-driven').textContent = '739';
           }
       }
