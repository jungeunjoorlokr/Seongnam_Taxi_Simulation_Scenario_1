// stats-loader.js 수정 버전 - 절대 경로 사용
       async function loadAndApplyStats() {
           ...
           try {
               // 절대 경로로 시도
               const csvUrl = 'file:///Users/jung-eunjoo/Desktop/scenario_seongnam_general_dispatch/visualization/dashboard/assets/data/simulation_12_data/stats.csv';
               ...
               document.getElementById('total-failed-calls').textContent = '3937';
               document.getElementById('failure-rate').textContent = '89.25';
